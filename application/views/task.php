        ...
        <script>
            ...
            app.controller('myCtrl', function ($scope, $http, $window, $location) {
                ...
                $scope.getData = function () {
                    $http.get('http://18.222.99.146/task/index.php/login/getAllData').then(function (response) {
                        $scope.items = response.data;
                    });
                }

                $scope.postData = function () {
                    var url = "http://18.222.99.146/task/index.php/login/postStudentData";
                ...
                $scope.delete = function (data) {
                    var url = 'http://18.222.99.146/task/index.php/login/delete?id=' + data.id;
