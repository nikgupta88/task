            ...
            app.controller('myCtrl', function ($scope, $http,$window,$location) {
                ...
                $scope.formSubmit = function () {
                    if ($scope.confirm) {
                        ...
                        var url="http://18.222.99.146/task/task/index.php/login/signup";
                ...
                $scope.login = function () {
                        console.log($scope.formData);
                        var url="http://18.222.99.146/task/task/index.php/login/login";
                        $http.post(url,$scope.formData).then(function(response){
                            console.log(response.data)
                            if(response.data.success){
                                window.location = "http://localhost/task/index.php/login";
                            }
//                            $scope.formData = {};
//                            alert('signup successfully');
                        });
